...
const Counseling = () => {
    return <div className="Counseling">
        <img src={decorationLeft} alt='Decoration Left' className='decoration-left'/>
        <h1>Asiste a una <span>asesoría</span> grupal gratuita<span>.</span></h1>
        <div className='counseling-content'>
            <a href='/' className='agenda'>AGENDA ASESORÍA</a>
            <a href='/' className='write'>ESCRÍBENOS AHORA</a>
