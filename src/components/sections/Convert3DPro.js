    ...
    return (
        <div className="Convert3DPro">
            <div className="convert-title">
                <h1>CONVIÉRTETE EN <span>PROFESIONAL 3D</span></h1>
            </div>
            <div className="convert-text">
                <p>Alcanza el nivel que deseas en menos de un año. Aprende y descubre sobre la industria creativa mas rentable del mercado.</p>
            </div>
